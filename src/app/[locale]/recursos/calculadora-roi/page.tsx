...
export const metadata: Metadata = {
  title: "Calculadora de ROI de automatización | Agenflow",
  description:
    "Calcula en un minuto cuánto tiempo y dinero recuperas al automatizar lo repetitivo. Con tus propios números, sin registro.",
};
